...
export type UserUpdateByAdminRequestType = z.infer<typeof UserUpdateByAdminRequestSchema>; // make a type for user self-update request validation schema using zod

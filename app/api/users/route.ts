...
export async function GET(request : NextRequest){
    ...
    //  const pageNumber = request.nextUrl.searchParams.get("page") || "1"  // get the page number from the query params, default to 1 if not provided
    //  const pageSize = request.nextUrl.searchParams.get("size") || "10"
